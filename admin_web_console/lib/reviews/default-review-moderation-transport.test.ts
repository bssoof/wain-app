...
import {
  resolveDefaultReviewModerationTransportMode,
  type DefaultReviewModerationTransportMode,
} from "./default-review-moderation-transport";

function resolveMode(
  env: Record<string, string | undefined>,
): DefaultReviewModerationTransportMode {
  return resolveDefaultReviewModerationTransportMode(env);
}

describe("resolveDefaultReviewModerationTransportMode", () => {
