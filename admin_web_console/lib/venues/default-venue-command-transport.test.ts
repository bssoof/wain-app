...
import {
  resolveDefaultVenueTransportMode,
  type DefaultVenueTransportMode,
} from "./default-venue-command-transport";

function resolveMode(env: Record<string, string | undefined>): DefaultVenueTransportMode {
  return resolveDefaultVenueTransportMode(env);
}

describe("resolveDefaultVenueTransportMode", () => {
