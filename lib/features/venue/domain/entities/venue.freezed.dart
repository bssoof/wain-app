...
@JsonKey(includeToJson: false) String get id;@JsonKey(name: 'name_ar') String get nameAr;@JsonKey(name: 'name_en') String get nameEn;@JsonKey(name: 'name_ar_norm') String get nameArNorm;@JsonKey(name: 'name_en_norm') String get nameEnNorm;@JsonKey(fromJson: _toDouble) double get lat;@JsonKey(fromJson: _toDouble) double get lng; String get city;@JsonKey(fromJson: _toStringList) List<String> get categories; VenueTags get tags;@JsonKey(name: 'all_tags', fromJson: _toStringList) List<String> get allTags;@JsonKey(name: 'min_price', fromJson: _toInt) int get minPrice;@JsonKey(name: 'max_price', fromJson: _toInt) int get maxPrice; String get currency;@JsonKey(fromJson: _toDouble) double get rating; String get phone; String get instagram; String get whatsapp; String get facebook; String get website;@JsonKey(name: 'google_place_id') String get googlePlaceId;@JsonKey(fromJson: _toStringList) List<String> get photos;@JsonKey(name: 'menu_images', fromJson: _toStringList) List<String> get menuImages;@JsonKey(fromJson: _toHoursMap) Map<String, List<VenueHours>> get hours;@JsonKey(name: 'is_24h') bool get is24h; VenuePartner get partner;@JsonKey(name: 'has_active_offers') bool get hasActiveOffers;@JsonKey(name: 'transport_enabled') bool get transportEnabled;@JsonKey(name: 'transport_partner_ids', fromJson: _toStringList) List<String> get transportPartnerIds;@JsonKey(name: 'transport_notes_ar') String get transportNotesAr;@JsonKey(name: 'transport_notes_en') String get transportNotesEn;@JsonKey(name: 'last_story_at', fromJson: _toTimestamp, toJson: _timestampToJson) Timestamp? get lastStoryAt;// Admin-managed status fields (Phase B — Venue Management)
@JsonKey(name: 'subscription_status') String get subscriptionStatus;@JsonKey(name: 'visibility_status') String get visibilityStatus;@JsonKey(name: 'operational_status') String get operationalStatus;@JsonKey(name: 'admin_status_updated_at', fromJson: _toTimestamp, toJson: _timestampToJson) Timestamp? get adminStatusUpdatedAt;@JsonKey(name: 'admin_status_updated_by') String? get adminStatusUpdatedBy;@JsonKey(name: 'created_at', fromJson: _toTimestamp, toJson: _timestampToJson) Timestamp? get createdAt;@JsonKey(name: 'updated_at', fromJson: _toTimestamp, toJson: _timestampToJson) Timestamp? get updatedAt;
...
@useResult
$Res call({
@JsonKey(includeToJson: false) String id,@JsonKey(name: 'name_ar') String nameAr,@JsonKey(name: 'name_en') String nameEn,@JsonKey(name: 'name_ar_norm') String nameArNorm,@JsonKey(name: 'name_en_norm') String nameEnNorm,@JsonKey(fromJson: _toDouble) double lat,@JsonKey(fromJson: _toDouble) double lng, String city,@JsonKey(fromJson: _toStringList) List<String> categories, VenueTags tags,@JsonKey(name: 'all_tags', fromJson: _toStringList) List<String> allTags,@JsonKey(name: 'min_price', fromJson: _toInt) int minPrice,@JsonKey(name: 'max_price', fromJson: _toInt) int maxPrice, String currency,@JsonKey(fromJson: _toDouble) double rating, String phone, String instagram, String whatsapp, String facebook, String website,@JsonKey(name: 'google_place_id') String googlePlaceId,@JsonKey(fromJson: _toStringList) List<String> photos,@JsonKey(name: 'menu_images', fromJson: _toStringList) List<String> menuImages,@JsonKey(fromJson: _toHoursMap) Map<String, List<VenueHours>> hours,@JsonKey(name: 'is_24h') bool is24h, VenuePartner partner,@JsonKey(name: 'has_active_offers') bool hasActiveOffers,@JsonKey(name: 'transport_enabled') bool transportEnabled,@JsonKey(name: 'transport_partner_ids', fromJson: _toStringList) List<String> transportPartnerIds,@JsonKey(name: 'transport_notes_ar') String transportNotesAr,@JsonKey(name: 'transport_notes_en') String transportNotesEn,@JsonKey(name: 'last_story_at', fromJson: _toTimestamp, toJson: _timestampToJson) Timestamp? lastStoryAt,@JsonKey(name: 'subscription_status') String subscriptionStatus,@JsonKey(name: 'visibility_status') String visibilityStatus,@JsonKey(name: 'operational_status') String operationalStatus,@JsonKey(name: 'admin_status_updated_at', fromJson: _toTimestamp, toJson: _timestampToJson) Timestamp? adminStatusUpdatedAt,@JsonKey(name: 'admin_status_updated_by') String? adminStatusUpdatedBy,@JsonKey(name: 'created_at', fromJson: _toTimestamp, toJson: _timestampToJson) Timestamp? createdAt,@JsonKey(name: 'updated_at', fromJson: _toTimestamp, toJson: _timestampToJson) Timestamp? updatedAt
});
...
/// Create a copy of Venue
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nameAr = null,Object? nameEn = null,Object? nameArNorm = null,Object? nameEnNorm = null,Object? lat = null,Object? lng = null,Object? city = null,Object? categories = null,Object? tags = null,Object? allTags = null,Object? minPrice = null,Object? maxPrice = null,Object? currency = null,Object? rating = null,Object? phone = null,Object? instagram = null,Object? whatsapp = null,Object? facebook = null,Object? website = null,Object? googlePlaceId = null,Object? photos = null,Object? menuImages = null,Object? hours = null,Object? is24h = null,Object? partner = null,Object? hasActiveOffers = null,Object? transportEnabled = null,Object? transportPartnerIds = null,Object? transportNotesAr = null,Object? transportNotesEn = null,Object? lastStoryAt = freezed,Object? subscriptionStatus = null,Object? visibilityStatus = null,Object? operationalStatus = null,Object? adminStatusUpdatedAt = freezed,Object? adminStatusUpdatedBy = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
as String,googlePlaceId: null == googlePlaceId ? _self.googlePlaceId : googlePlaceId // ignore: cast_nullable_to_non_nullable
...
as Timestamp?,subscriptionStatus: null == subscriptionStatus ? _self.subscriptionStatus : subscriptionStatus // ignore: cast_nullable_to_non_nullable
as String,visibilityStatus: null == visibilityStatus ? _self.visibilityStatus : visibilityStatus // ignore: cast_nullable_to_non_nullable
as String,operationalStatus: null == operationalStatus ? _self.operationalStatus : operationalStatus // ignore: cast_nullable_to_non_nullable
as String,adminStatusUpdatedAt: freezed == adminStatusUpdatedAt ? _self.adminStatusUpdatedAt : adminStatusUpdatedAt // ignore: cast_nullable_to_non_nullable
as Timestamp?,adminStatusUpdatedBy: freezed == adminStatusUpdatedBy ? _self.adminStatusUpdatedBy : adminStatusUpdatedBy // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Venue() when $default != null:
return $default(_that.id,_that.nameAr,_that.nameEn,_that.nameArNorm,_that.nameEnNorm,_that.lat,_that.lng,_that.city,_that.categories,_that.tags,_that.allTags,_that.minPrice,_that.maxPrice,_that.currency,_that.rating,_that.phone,_that.instagram,_that.whatsapp,_that.facebook,_that.website,_that.googlePlaceId,_that.photos,_that.menuImages,_that.hours,_that.is24h,_that.partner,_that.hasActiveOffers,_that.transportEnabled,_that.transportPartnerIds,_that.transportNotesAr,_that.transportNotesEn,_that.lastStoryAt,_that.subscriptionStatus,_that.visibilityStatus,_that.operationalStatus,_that.adminStatusUpdatedAt,_that.adminStatusUpdatedBy,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
switch (_that) {
case _Venue():
return $default(_that.id,_that.nameAr,_that.nameEn,_that.nameArNorm,_that.nameEnNorm,_that.lat,_that.lng,_that.city,_that.categories,_that.tags,_that.allTags,_that.minPrice,_that.maxPrice,_that.currency,_that.rating,_that.phone,_that.instagram,_that.whatsapp,_that.facebook,_that.website,_that.googlePlaceId,_that.photos,_that.menuImages,_that.hours,_that.is24h,_that.partner,_that.hasActiveOffers,_that.transportEnabled,_that.transportPartnerIds,_that.transportNotesAr,_that.transportNotesEn,_that.lastStoryAt,_that.subscriptionStatus,_that.visibilityStatus,_that.operationalStatus,_that.adminStatusUpdatedAt,_that.adminStatusUpdatedBy,_that.createdAt,_that.updatedAt);}
}
...
@override@JsonKey(name: 'visibility_status') final  String visibilityStatus;
@override@JsonKey(name: 'operational_status') final  String operationalStatus;
@override@JsonKey(name: 'admin_status_updated_at', fromJson: _toTimestamp, toJson: _timestampToJson) final  Timestamp? adminStatusUpdatedAt;
@override@JsonKey(name: 'admin_status_updated_by') final  String? adminStatusUpdatedBy;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Venue&&(identical(other.id, id) || other.id == id)&&(identical(other.nameAr, nameAr) || other.nameAr == nameAr)&&(identical(other.nameEn, nameEn) || other.nameEn == nameEn)&&(identical(other.nameArNorm, nameArNorm) || other.nameArNorm == nameArNorm)&&(identical(other.nameEnNorm, nameEnNorm) || other.nameEnNorm == nameEnNorm)&&(identical(other.lat, lat) || other.lat == lat)&&(identical(other.lng, lng) || other.lng == lng)&&(identical(other.city, city) || other.city == city)&&const DeepCollectionEquality().equals(other._categories, _categories)&&(identical(other.tags, tags) || other.tags == tags)&&const DeepCollectionEquality().equals(other._allTags, _allTags)&&(identical(other.minPrice, minPrice) || other.minPrice == minPrice)&&(identical(other.maxPrice, maxPrice) || other.maxPrice == maxPrice)&&(identical(other.currency, currency) || other.currency == currency)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.instagram, instagram) || other.instagram == instagram)&&(identical(other.whatsapp, whatsapp) || other.whatsapp == whatsapp)&&(identical(other.facebook, facebook) || other.facebook == facebook)&&(identical(other.website, website) || other.website == website)&&(identical(other.googlePlaceId, googlePlaceId) || other.googlePlaceId == googlePlaceId)&&const DeepCollectionEquality().equals(other._photos, _photos)&&const DeepCollectionEquality().equals(other._menuImages, _menuImages)&&const DeepCollectionEquality().equals(other._hours, _hours)&&(identical(other.is24h, is24h) || other.is24h == is24h)&&(identical(other.partner, partner) || other.partner == partner)&&(identical(other.hasActiveOffers, hasActiveOffers) || other.hasActiveOffers == hasActiveOffers)&&(identical(other.transportEnabled, transportEnabled) || other.transportEnabled == transportEnabled)&&const DeepCollectionEquality().equals(other._transportPartnerIds, _transportPartnerIds)&&(identical(other.transportNotesAr, transportNotesAr) || other.transportNotesAr == transportNotesAr)&&(identical(other.transportNotesEn, transportNotesEn) || other.transportNotesEn == transportNotesEn)&&(identical(other.lastStoryAt, lastStoryAt) || other.lastStoryAt == lastStoryAt)&&(identical(other.subscriptionStatus, subscriptionStatus) || other.subscriptionStatus == subscriptionStatus)&&(identical(other.visibilityStatus, visibilityStatus) || other.visibilityStatus == visibilityStatus)&&(identical(other.operationalStatus, operationalStatus) || other.operationalStatus == operationalStatus)&&(identical(other.adminStatusUpdatedAt, adminStatusUpdatedAt) || other.adminStatusUpdatedAt == adminStatusUpdatedAt)&&(identical(other.adminStatusUpdatedBy, adminStatusUpdatedBy) || other.adminStatusUpdatedBy == adminStatusUpdatedBy)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,nameAr,nameEn,nameArNorm,nameEnNorm,lat,lng,city,const DeepCollectionEquality().hash(_categories),tags,const DeepCollectionEquality().hash(_allTags),minPrice,maxPrice,currency,rating,phone,instagram,whatsapp,facebook,website,googlePlaceId,const DeepCollectionEquality().hash(_photos),const DeepCollectionEquality().hash(_menuImages),const DeepCollectionEquality().hash(_hours),is24h,partner,hasActiveOffers,transportEnabled,const DeepCollectionEquality().hash(_transportPartnerIds),transportNotesAr,transportNotesEn,lastStoryAt,subscriptionStatus,visibilityStatus,operationalStatus,adminStatusUpdatedAt,adminStatusUpdatedBy,createdAt,updatedAt]);
