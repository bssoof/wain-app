...
as bool,lastStoryAt: freezed == lastStoryAt ? _self.lastStoryAt : lastStoryAt // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Venue():
return $default(_that.id,_that.nameAr,_that.nameEn,_that.nameArNorm,_that.nameEnNorm,_that.lat,_that.lng,_that.city,_that.categories,_that.tags,_that.allTags,_that.minPrice,_that.maxPrice,_that.currency,_that.rating,_that.phone,_that.instagram,_that.whatsapp,_that.facebook,_that.website,_that.photos,_that.menuImages,_that.hours,_that.is24h,_that.partner,_that.hasActiveOffers,_that.lastStoryAt,_that.createdAt,_that.updatedAt);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,nameAr,nameEn,nameArNorm,nameEnNorm,lat,lng,city,const DeepCollectionEquality().hash(_categories),tags,const DeepCollectionEquality().hash(_allTags),minPrice,maxPrice,currency,rating,phone,instagram,whatsapp,facebook,website,const DeepCollectionEquality().hash(_photos),const DeepCollectionEquality().hash(_menuImages),const DeepCollectionEquality().hash(_hours),is24h,partner,hasActiveOffers,lastStoryAt,createdAt,updatedAt]);
