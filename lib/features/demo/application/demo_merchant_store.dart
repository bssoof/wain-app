...
class DemoMerchantStore {
  ...
  late List<MerchantWalletReversalRequest> _walletReversalRequests;
  ...
  var _localWalletReversalSerial = 0;
  ...
  Stream<List<MerchantWalletReversalRequest>> watchWalletReversalRequests() =>
      _watch(
        () => List<MerchantWalletReversalRequest>.unmodifiable(
          _walletReversalRequests,
        ),
      );
  ...
  void reset({bool notify = true}) {
    ...
    _walletReversalRequests = <MerchantWalletReversalRequest>[];
    _redeemedTokens.clear();
    _localOfferSerial = 0;
    _localStorySerial = 0;
    _localTopUpSerial = 0;
    _localWalletEntrySerial = 0;
    _localWalletReversalSerial = 0;
    if (notify) _notify();
  }
