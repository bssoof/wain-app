...
void main() {
  group('Security & Integrity Flows', () {
    ...
    test(
      'Data Integrity: User email and phone should be treated as immutable by client logic',
      () async {
    ...
    test(
      'Anti-Replay: Client handles "failed-precondition" error from Cloud Function',
      () async {
    ...
    test(
      'Unauthorized Access: Client logic does not attempt invalid writes',
      () async {
