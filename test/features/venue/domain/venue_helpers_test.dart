...
void main() {
  ...
  group('isOpenNow()', () {
    ...
    test(
      'spans_midnight — NEXT DAY early morning (Tuesday 01:00, Monday shift) → true',
      () {
    ...
    test(
      'spans_midnight — NEXT DAY past close (Tuesday 04:00, Monday shift) → false',
      () {
        final venue = _makeVenue(
          hours: {
            'monday': [
  ...
  group('MerchantAnalytics', () {
    test('constructs all fields correctly', () {
    ...
    test('empty-like construction can still represent partial data', () {
      const analytics = MerchantAnalytics(
        viewsTotal: 10,
        viewsThisWeek: 0,
        viewsLastWeek: 0,
